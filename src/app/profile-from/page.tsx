        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>Enter Vendor Assessement ID.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>Enter the firm name.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
            ...
            <FormItem>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="Desktop Assessment In Progress">
                    Desktop Assessment In Progress
                  </SelectItem>
                  <SelectItem value="Desktop Assessment Completed">
                    Desktop Assessment Completed
                  </SelectItem>
                  <SelectItem value="Video Assessment  In Progress">
                    Video Assessment In Progress
                  </SelectItem>
                  <SelectItem value="Video Assessment completed">
